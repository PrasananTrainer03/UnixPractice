...
public class EmployMain {
	...
	static EmployBAL dao = new EmployBAL();
	...
	public static void deleteEmployMain() {
		...
		empno = sc.nextInt();
		System.out.println(dao.deleteEmployBal(empno));
	}
	...
	public static void updateEmployMain() throws EmployException {
		...
		System.out.println(dao.updateEmployBal(employ));
	}
	...
	public static void searchEmployMain() {
		...
		System.out.println("Enter Employ Number   ");
		empno = sc.nextInt();
		Employ employ = dao.searchEmployBal(empno);
		if (employ!=null) {
	...
	public static void addEmployMain() throws EmployException {
		...
		System.out.println("Enter Basic   ");
		employ.setBasic(sc.nextDouble());
		System.out.println(dao.addEmployBal(employ));
	}
